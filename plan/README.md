...
| **Sunucu kapanışı**: kod ve doküman **bitti** (`ServiceShutdown` + dört serviste `StopAsync`, `Program.ShutdownAsync`; Ctrl+C · pencere kapatma · süreç çıkışı aynı idempotent yolu koşar). Kalan: doğrulama listesi | `sunucu-kapanis.md` |

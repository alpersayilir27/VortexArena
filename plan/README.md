...
| **İskelet zemin düzeltmesi** (gönderende, filtreli göz-ofseti — gövdenin OS zemin tahmini yüzünden zeminin altında/havada çizilmesi; kare başına ham sabitleme YASAK, Sistem-Ozeti §7): henüz kod yazılmadı; önce `[AvatarTanı]` ile saha ölçümü | `iskelet-zemin-duzeltmesi.md` |

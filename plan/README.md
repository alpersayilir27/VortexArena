...
| Elde tutulan eşya + atış olayları: **Faz 0–3 + soket kavrama + olay zamanlaması bitti**. Kalan: ⚠️ **altı silahın kavramasını bake etmek** (araç hazır — `Kavrama Pozu Stüdyosu` → El Ekle → Bake) · tracer/soket değerleri · bomba | `elde-tutulan-esya-ve-atis-olaylari.md` |

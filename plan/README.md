...
| **Kavrama: avuç çerçevesi + ikinci el**: kod (`HandGripPivot`, `ItemGripSolver`) ve doküman **bitti**. Kalan: 13 silahın kavramasını stüdyoda yazmak (yazılmadan iki elli çözüm koşmaz: ön kabza ekseni oluşmaz) + doğrulama | `iki-elli-kavrama.md` |

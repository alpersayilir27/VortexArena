...
| **Engel ihlali** (oyuncu İÇ engelin içine girince karartma + saniyede 30 HP + admin halkasının kırmızı yanıp sönmesi): tasarım hazır — sözleşme `Obstacle` layer'ı (collider KONVEKS olmalı), tespit ağırlıklı nokta örneklemesiyle, bayrak `SnapshotEntry` bit3 ile taşınır. Kod HİÇ yazılmadı; önce protokol dokümanı | `engel-ihlali.md` |

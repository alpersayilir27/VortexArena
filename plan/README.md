...
| **Hayalet avatar** (ölü / kalibresiz uzak oyuncu ayrı bir modelle yarı saydam çizilir; kalibresizken silah da elden gider): shader, materyal, kod, hayalet modeli, editör aracı, prefab kurulumu ve doküman **bitti**. Kalan: doğrulama listesi + kalibrasyon dönüşünde şarjör kararı | `hayalet-avatar.md` |

...
| Elde tutulan eşya + atış olayları: **Faz 0–3 + ön kabza kapısı/göstergesi + olay zamanlaması bitti**. Kalan: ⚠️ **13 silahın kavramasını yazmak** (araç hazır — `Kavrama Pozu Stüdyosu`, prefab kipinde, el başına poz + silaha özel parmak rigi) · `HandGripConvention.*AnchorToWrist` sabitini editör logundan yapıştırmak · tracer/gösterge değerleri · bomba | `elde-tutulan-esya-ve-atis-olaylari.md` |

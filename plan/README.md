...
| Elde tutulan eşya + atış olayları: **Faz 0–3 + soket kavrama + olay zamanlaması bitti**. Kalan: ⚠️ **13 silahın kavramasını yazmak** (araç hazır — `Kavrama Pozu Stüdyosu`, prefab kipinde, el başına poz + parmak preset'i) · `HandGripConvention.*AnchorToWrist` sabitini editör logundan yapıştırmak · tracer/soket değerleri · bomba | `elde-tutulan-esya-ve-atis-olaylari.md` |

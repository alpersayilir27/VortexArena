...
| Yerel kol görseli: oyuncu kendi kollarını görsün (bugün yalnız BB rig'inin elleri görünüyor; Movement SDK gövde avatarı kalibre edilen rig'le çakıştığı için kaldırıldı) | `yerel-kol-gorseli.md` |

...
| Avatarlar doğru yerde ama **yükseklikleri yanlış** (yere gömük / havada) | Kalibrasyonda kumandanın ucu yere değmemiş; ya da `ArenaCalibrator.floorProbeDropMeters` o kumanda modeli için henüz ölçülmemiş (varsayılan 0,08 m tahmindir) | O başlıkta kumandanın **ucunu zemine değdirerek** yeniden kalibre et (nasıl tuttuğun önemli değil). Gömülmenin gerçek olup olmadığını kalibrasyondan birkaç saniye sonraki `[Kalibre] hizalama sonrası kafa yüksekliği` satırı söyler — o sayı oyuncunun gerçek göz yüksekliğine eşit olmalı; "zemin sapması" uyarısı tek başına gömülme kanıtı DEĞİLDİR (başlığın zemin tahmini bayatken de çıkar, hizalama doğruyken). Tüm başlıklarda aynı yönde sapma varsa ofset yanlıştır: §3'teki reçeteyle ölç, alanı güncelle, APK'yı yeniden al |

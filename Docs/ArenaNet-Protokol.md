...
> | Maç nasıl biter? | **Hangisi önce dolarsa:** ya `scoreLimit` (bir takım gerekli turu alır ya da `2 × scoreLimit − 1` tavanına varılır), ya da **maç süresi**. Süre biterken koşan tur önce normal yolla kapanır (ayakta kalan sayısı), sonra **çok tur alan maçı kazanır**, eşitse berabere. ⚠️ İki koşul aynı turda dolarsa **limit** kazanır — sonuç aynıdır, ama sunucu satırı maçı gerçekten bitiren şeyi yazar. Erken bitirmek operatörün `end_match`'idir |
...
> | Tur nasıl biter? | Bir takımın **tüm** çevrimiçi oyuncuları ölü → diğer takıma +1. Turun kendi sayacı yoktur; **maç süresi** koşan turun ortasında biterse o tur son turdur ve **çok kişi ayakta kalan** alır, eşitse kimseye puan yok |

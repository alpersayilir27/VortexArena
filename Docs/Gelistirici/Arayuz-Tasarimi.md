...
- **Her iki panel de `AdminStatsPanel`'in kart kabuğunu taşır** (`StatsPanel` → `Fill`; `PanelBG`
  arka planı + `ChamferRect_20` dolgu, **1360×765** — 16:9, 1920×1080 referansta ekran alanının
  yarısı). ⚠️ **Kartın en-boy oranını değiştirmeyin** —
...
- **Admin arayüzü 16:9 içindir** (`CanvasScaler` 1920×1080 referans, eşleme `Expand`): tüm
  ...
  16:9 kartla ekran alanının yarısını kaplar. Başka oranda bir pencere **kırpılmaz**, kenarda boşluk

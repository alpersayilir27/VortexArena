...
| `BurgerOrderBubble` | Siparişi (`bun_bottom,patty,cheese,bun_top`) okunur satırlara çevirip oyuncuya döner. ⚠️ **Bilinmeyen anahtar olduğu gibi yazılır**, atılmaz: sözlük sunucu tarafında malzeme kazanabilir ve sessizce eksilen bir satır "yanlış sipariş" diye okunurdu |

...
- **Çalma yoktur:** dolu objeye gelen ikinci `object_grab` sessizce düşer. Teklik ayrı bir kilit
  değil, **sahipliğin kendisidir** — "aynı anda tek kişi tutsun" diye ikinci bir mekanizma yazılmaz.
...
195. **Sessiz Wi-Fi ölümünü TCP fark etmez; ölü bağlantıyı istemcinin kendisi düşürür.** Gözlüğün
    ...
    gelmezse istemci soketi kendisi düşürür (§8). Aynı sebeple `ConnectAsync` `CONNECT_TIMEOUT`
    ile sınırlanır — ulaşılamayan adrese SYN dakikalarca yeniden denenir ve backoff sırası hiç
    gelmezdi.

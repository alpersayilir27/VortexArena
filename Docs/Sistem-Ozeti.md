...
**Rol ayrımı yalnız SESTEDİR ve yalnız POV kipinde vardır** (`SpectatorAudioFocus`): admin
gözlemci POV'da **yalnız izlediği oyuncunun** silahını duyar, sahadaki diğerlerinin atışları
susar — hepsi birden çalınca operatör hangi sesin izlediği oyuncuya ait olduğunu ayırt edemez.
⚠️ **Kuş bakışında ve serbest kipte filtre YOKTUR**, her atış eskisi gibi mesafeye göre duyulur:
o kiplerde operatör sahanın tamamına bakar ve atış sesi "nerede çatışma var" sorusunun cevabıdır.
...
izlenen oyuncuya odaklanılır, diğerlerinin atışı susar, yoksa POV'daki tek ses kalabalıkta
kaybolurdu.

...
194. **Transform'la sürülen Rigidbody'de interpolasyon KAPALI olmalıdır; taşınırken kapatılan
    ...
    bomba **yerin içinden geçer** ve yalnız fitil onu bitirir; `Throwable.Arm` gövdeyi olduğu gibi
    kabul etmez, ihtiyacı olan her alanı (kinematik, çarpışma, interpolasyon, yerçekimi) kendi yazar
    — uzak kopya taze prefabdan doğduğu için bu da yalnız atanın kopyasında görülür.
